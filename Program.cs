...
namespace Application
{
    public class Program
    {
...

        {
            ...
            Console.WriteLine("------ Linea Emergencia Operations ------");
            PerformLineaEmergenciaOperations();

            Console.WriteLine("------ Alerta Operations ------");
            PerformAlertaOperations();

            Console.WriteLine("------ Contacto de Emergencia Operations ------");
        ...
        {
            Console.WriteLine("------Operaciones ContactoEmergencia...");

            ContactoEmergencia contactoEmergencia = new ContactoEmergencia(string.Empty, 25, "Nombre1", "Apellido1", "nombre1.apellido1@email.com", "Familiar", "3107568976", "Nombre1 Apellido1");
            ...
            updatedContactoEmergencia.Age = 30;
            updatedContactoEmergencia.FirstName = "NombreActualizado";
            updatedContactoEmergencia.LastName = "ApellidoActualizado";
            updatedContactoEmergencia.Email = "nombre.apellido.actualizado@email.com";
            updatedContactoEmergencia.Parentezco = "Amigo";
            updatedContactoEmergencia.TelefonoContacto = "3216549870";
            updatedContactoEmergencia.FullName = "NombreActualizado ApellidoActualizado";
        ...
        private static void PerformMayorOperations()
        {
            ...
            Mayor mayor = new Mayor(string.Empty, "Viviana Garcia", 1018506038);
            ...
            {
                Console.WriteLine($"{item.Id}{item.Id} {item.AlarmaEmergencia}");
            }

            Console.WriteLine("------ FindById Mayor");

            var oneMayor = mayorRepo.FindById(allMayor.First().Id);
            Console.WriteLine($"{oneMayor.Id} {oneMayor.Id} {oneMayor.AlarmaEmergencia}");
            ...
            updatedMayor.Id = "123";
            oneMayor.AlarmaEmergencia = new AlarmaEmergencia
            {
                Tipo = "Incendio",
                Nivel = 2,
